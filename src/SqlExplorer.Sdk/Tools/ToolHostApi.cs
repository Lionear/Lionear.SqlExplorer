...
public static class ToolHostApi
{
    ...
    // v3 (2026-07-19): the extensibility family (SE-164) — ISubsystemPlugin + IPluginRuntimeContext +
    //                  IPluginStorage and the capability model. Additive: classic tools are untouched.
